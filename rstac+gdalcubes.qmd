...
- 🛰️ Create raster data cubes with a user-defined spatiotemporal geometry using `cube_view()` and `raster_cube()` in `gdalcubes` and perform a basic NDVI change analysis
