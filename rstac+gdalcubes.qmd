...
- 🚀 Retrieve STAC items for Sentinel-2 imagery in a specified AOI (roughly "Münsterland", Germany) and time range (June 2025) using `rstac`
...
Make sure to have R >=4.5.2  and rtools >=6690. Install `sf` and `gdalcubes` from source.
